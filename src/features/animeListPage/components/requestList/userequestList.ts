...
export const useRequestList = (
  ...
  const categorizedRequests = useMemo<CategorizedRequests>(() => {
    const join: ListRequest[] = [];
    const edit: ListRequest[] = [];
  ...
  const checkShowAccept = useCallback((req: ListRequest): boolean => {
