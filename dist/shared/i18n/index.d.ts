export declare const NAMESPACES: readonly ["common", "HomePage", "NewsDetailPage", "RankingSection", "CharactersSection", "StaffSection", "CharacterPage", "StatisticsSection", "AnimeModal", "MainContentArea", "AnimeDetail"];
