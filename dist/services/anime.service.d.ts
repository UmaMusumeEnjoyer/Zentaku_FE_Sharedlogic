export declare const animeService: {
    ...
    getAnimeCharacter: (id: number | string) => Promise<import("axios").AxiosResponse<any, any, {}> | {
        data: {};
    }>;
    getAnimeStats: (id: number | string) => Promise<import("axios").AxiosResponse<any, any, {}> | {
        data: {};
    }>;
